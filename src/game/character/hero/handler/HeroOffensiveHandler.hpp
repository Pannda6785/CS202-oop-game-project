...
class HeroOffensiveHandler : public TapHandler {
    static constexpr float INVINCIBILITY_DURATION = 0.340f; // minor
    static constexpr float MOVEMENT_MODIFIER_VALUE_1 = 2.0f;
    static constexpr float MOVEMENT_MODIFIER_DURATION_1 = 0.220f;
    static constexpr float MOVEMENT_MODIFIER_VALUE_2 = 0.4f;
    static constexpr float MOVEMENT_MODIFIER_DURATION_2 = 0.400f;

    static constexpr float COOLDOWN = 4.0f;
    static constexpr float ARROW_LOCK = 0.340f;
